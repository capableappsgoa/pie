      ...
      <aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white shadow-md sm:translate-x-0 bg-white shadow-md dark:border-gray-700" aria-label="Sidebar">
        <div className="h-full px-3 pb-4 overflow-y-auto bg-white shadow-md">
          <ul className="space-y-2 font-medium">
            <li>
              <Link href="/properties" className="flex items-center p-2 rounded-lg text-black hover:bg-blue-400 dark:hover:bg-gray-700 group">
            ...
            <li>
              <Link href="/webapp" className="flex items-center p-2 text-black rounded-lg text-black hover:bg-blue-400 dark:hover:bg-gray-700 group">
            ...
            <li>
              <Link href="/portfolio"className="flex items-center p-2 text-black rounded-lg text-black hover:bg-blue-400 dark:hover:bg-gray-700 group">
