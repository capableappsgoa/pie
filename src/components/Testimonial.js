            ...
            <ul class="space-y-8">
                <li class="text-sm leading-6">
                    <div class="relative group">
                        <div
                            class="absolute transition rounded-lg opacity-25 -inset-1 bg-gradient-to-r blur duration-400 group-hover:opacity-100 group-hover:duration-200">
                        </div><a href="https://twitter.com/kanyewest" class="cursor-pointer">
                            <div
                                class="relative p-6 space-y-6 leading-none rounded-lg shadow-md ring-1 ring-gray-900/5">
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div class="flex items-center space-x-4"><img
                                    ...
                                    <div>
                                        <h3 class="text-lg font-semibold text-slate-800">Tim Cook</h3>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div class="flex items-center space-x-4"><img
                                    ...
                                    <div>
                                        <h3 class="text-lg font-semibold text-slate-800">Parag Agrawal</h3>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div class="flex items-center space-x-4"><img
                                    ...
                                    <div>
                                        <h3 class="text-lg font-semibold text-slate-800">Satya Nadella</h3>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div class="flex items-center space-x-4"><img
                                    ...
                                    <div>
                                        <h3 class="text-lg font-semibold text-slate-800">Dan Schulman</h3>
                                        <p class="text-slate-800 text-md">CEO of PayPal</p>
                                    </div>
                                </div>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div class="flex items-center space-x-4"><img
                                    ...
                                    <div>
                                        <h3 class="text-lg font-semibold text-slate-800">Satya Nadella</h3>
                                        <p class="text-slate-800 text-md">CEO of Microsoft</p>
                                    </div>
                                </div>
                                <p class="leading-normal text-slate-800 text-md">Tortor dignissim convallis aenean et
                                    tortor at. At ultrices mi tempus imperdiet nulla malesuada. Id cursus metus aliquam
